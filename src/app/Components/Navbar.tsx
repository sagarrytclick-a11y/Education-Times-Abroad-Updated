      ...
      <div className="border-b border-slate-100">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="flex h-20 lg:h-24 items-center justify-between">
            <Link href="/" className="flex-shrink-0"><img src={SITE_IDENTITY.assets.logo.main} alt="Logo" width={100} height={100} className="hover:opacity-80 transition-opacity" /></Link>
            ...
            <button onClick={openModal} className="hidden lg:block px-8 py-3 text-sm font-bold text-blue-600 border-2 border-blue-500 rounded-full hover:bg-blue-50 transition-all duration-200 shadow-sm hover:shadow-md">
              Book Consultation
            </button>
